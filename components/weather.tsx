...
const WeatherInformation = ({
  ...
  return (
    <View className="w-full flex flex-grow justify-between mt-4">
      ...
      <View className="flex flex-row justify-between items-center w-full mt-6 gap-2">
        <View className="flex flex-row justify-center items-center gap-2 bg-white/10 rounded-3xl h-16 p-4">
          <Image
